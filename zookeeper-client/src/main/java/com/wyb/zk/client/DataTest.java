...
public class DataTest {
    ...
    public void getData() throws KeeperException, InterruptedException {
        byte[] data = zooKeeper.getData("/wyb", false, null);
        System.out.println(new String(data));
    }

    @Test
    public void getData2() throws KeeperException, InterruptedException {
        byte[] data = zooKeeper.getData("/wyb", true, null);
        System.out.println(new String(data));
    ...
    public void getData3() throws KeeperException, InterruptedException {
        Stat stat = new Stat();
        zooKeeper.getData("/wyb", new Watcher() {
            @Override
            public void process(WatchedEvent event) {
                try {
    ...
    public void getData4() throws KeeperException, InterruptedException {
        zooKeeper.getData("/wyb", false, new AsyncCallback.DataCallback() {
            @Override
    ...
    public void getChild() throws KeeperException, InterruptedException {
        List<String> children = zooKeeper.getChildren("/wyb", false);
    ...
    public void createData() throws KeeperException, InterruptedException {
        ...
        list.add(acl2);
        list.add(acl3);
        zooKeeper.create("/wyb/lu", "hello".getBytes(), list, CreateMode.PERSISTENT);
    }

    @Test
    public void getChild2() throws KeeperException, InterruptedException {
        List<String> children = zooKeeper.getChildren("/wyb", event -> {
            System.out.println(event.getPath());
            try {
